...
#define twoKpDef  (2.0f * 0.5f)  //(2.0f * 0.5f) // 2 * proportional gain  0.13
#define twoKiDef  (2.0f * 0.0f)  //(2.0f * 0.0f) // 2 * integral gain       0.3


// Transform raw data of accelerometer & gyroscope
#define MPU6050_AXOFFSET -37
#define MPU6050_AYOFFSET -8
#define MPU6050_AZOFFSET 265
...
#define MPU6050_GXOFFSET -39
#define MPU6050_GYOFFSET 27
