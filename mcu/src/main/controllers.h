...
public:
     ...
     *
     * @param  {float} current_angle : Actual state.
     * @param  {float} target_angle  : Target state.
...
public:
     ...
     *
     * @param  {float} current_angle : Current state.
     * @param  {float} target_angle  : Target state.
...
public:
     ...
     *
     * @param  {float} previous_angle : Current angle
     */
